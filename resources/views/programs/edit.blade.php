    ...
    <div class="page-header">
        <div class="page-title">
            <div class="back-button">
                <a href="{{ route('programs.show', $program) }}" class="btn-back">
                    <i class="fas fa-arrow-left"></i>
                </a>
            </div>
            <div class="title-content">
                <h1>Editar Programa Técnico</h1>
                <p class="page-subtitle">Modifica la información del programa técnico</p>
            </div>
        </div>
        ...
        <div class="form-card">
            <div class="form-header">
                ...
                <div class="header-content">
                    <h2>Editar: {{ $program->name }}</h2>
                    <p class="header-subtitle">Actualiza la información del programa técnico</p>
                </div>
            </div>

            <form action="{{ route('programs.update', $program) }}" method="POST" class="form-content">
                @csrf
                @method('PUT')
